...
If you discover a security vulnerability in falak, please report it
...
This policy covers the `falak` crate and its published API. Vulnerabilities
in dependencies should be reported to the respective upstream projects (and
flagged here if they affect falak users).
